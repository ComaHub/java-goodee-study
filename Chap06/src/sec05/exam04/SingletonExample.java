...
public class SingletonExample {
	public static void main(String[] args) {
		// Singleton singleton = new Singleton(); => private constructor!
		
		Singleton singleton1 = Singleton.getInstance(); // => 유일 객체의 참조값 반환
		Singleton singleton2 = Singleton.getInstance();
		
		if (singleton1 == singleton2) System.out.println("같은 Singleton 객체");
		else System.out.println("서로 다른 Singleton 객체");
