...
public class EnumWeekExample {
	public static void main(String[] args) {
		Calendar calendar = Calendar.getInstance(); // Calender 객체 
		
		Week today = null; // Enum 타입 변수 선언
		int week = calendar.get(Calendar.DAY_OF_WEEK); // 오늘의 요일 얻기 (일요일이 1)
		...
		System.out.println("오늘 요일: " + today); // 열거 객체의 문자열이 출력(열거 상수 이름과 동일한 문자열을 가짐)
		...
		// 요일을 숫자 1, 2, 3 ... 으로 쓰는 것보다 가독성이 좋음
