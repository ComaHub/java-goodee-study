...
// 마지막까지 잘 도착했어요!!
	...
	public static void main(String[] args) {
		...
		System.out.println("합: " + calculator.add(inputA, inputB));
		System.out.println("곱: " + calculator.multiple(inputA, inputB));
		
		try {
			System.out.println("나누기: " + calculator.divide(inputA, inputB)); // 예외 발생 가능 코드
